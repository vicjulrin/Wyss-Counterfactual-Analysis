...
The functions required to run this reproducible workflow are stored in the `functions/` folder, and the example input data are stored in the `inputs/` folder.
...
The second selection step compares candidate treatment models and keeps the best-ranked set of covariates according to AIC.
